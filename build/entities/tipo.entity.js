...
var tipo_entity_exports = {};
__export(tipo_entity_exports, {
  Tipo: () => Tipo
});
module.exports = __toCommonJS(tipo_entity_exports);
...
__decorateClass([
  (0, import_typeorm.PrimaryGeneratedColumn)("uuid", { name: "idpostagem" })
...
__decorateClass([
  (0, import_typeorm.ManyToOne)(() => Usuario, (usuario) => usuario.postagens, { nullable: false, eager: true, onDelete: "CASCADE" }),
  (0, import_typeorm.JoinColumn)({ name: "idusuario" })
], Postagem.prototype, "usuario", 2);
__decorateClass([
  (0, import_typeorm.Column)({ name: "idusuario", type: "uuid" })
...
__decorateClass([
  (0, import_typeorm3.PrimaryGeneratedColumn)("increment", { name: "idtipo" })
], Tipo.prototype, "id", 2);
__decorateClass([
...
__decorateClass([
  (0, import_typeorm3.OneToMany)(() => Usuario, (usuario) => usuario.idTipo)
