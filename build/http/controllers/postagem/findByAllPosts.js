...
var findByAllPosts_exports = {};
__export(findByAllPosts_exports, {
  findByAllPosts: () => findByAllPosts
});
module.exports = __toCommonJS(findByAllPosts_exports);
...
async function findByAllPosts(request, reply) {
  const registerQueryShcema = import_zod2.default.object({
    page: import_zod2.default.coerce.number().default(1),
    limit: import_zod2.default.coerce.number().default(10)
  });
